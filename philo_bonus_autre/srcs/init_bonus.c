...
{
	sems->die_sem = sem_open(DIE_SEM_NAME, O_CREAT | O_EXCL, S_IRUSR | S_IWUSR, 0644, 1);
	sems->fork_sem = sem_open(FORK_SEM_NAME,O_CREAT | O_EXCL, S_IRUSR | S_IWUSR,0644, count);
	sems->meal_sem = sem_open(MEAL_SEM_NAME,O_CREAT | O_EXCL, S_IRUSR | S_IWUSR, 0644, 0);
